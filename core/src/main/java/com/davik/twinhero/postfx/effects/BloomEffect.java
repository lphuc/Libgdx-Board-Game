...
import com.davik.twinhero.postfx.core.base.CompositeVfxEffect;
...
import com.davik.twinhero.postfx.util.CombineEffect;
import com.davik.twinhero.postfx.util.CopyEffect;
import com.davik.twinhero.postfx.util.GammaThresholdEffect;
...
public class BloomEffect extends CompositeVfxEffect implements ChainVfxEffect {
    ...
    public static class Settings {
        ...
        public Settings(int blurPasses, float bloomThreshold, float baseIntensity, float baseSaturation,
            ...
            this(GaussianBlurEffect.BlurType.Gaussian5x5b, blurPasses, 0, bloomThreshold, baseIntensity, baseSaturation,
                    bloomIntensity,
                    bloomSaturation);
        }

        public Settings(GaussianBlurEffect.BlurType blurType, int blurPasses, float blurAmount, float bloomThreshold,
